...
class Parameter_server:
    ...
    def broadcast(self, theta0, theta0_last, theta_li, alpha,l1_lambda, weight_lambda, delta):
    ...
    def train(self, init_theta0, init_theta, alpha, l1_lambda, weight_lambda):
        ...
        for i in range(num_iter):
            ...
            rec_theta0, rec_theta = self.broadcast(self.theta0_li[-1], self.theta0_li[-2], self.theta_li[-1], alpha, l1_lambda,
                                                   weight_lambda, delta)
            ...
            if (i + 1) % 10 == 0:
                ...
                print("step:", i, " acc:", acc, "loss:", loss," Sync:",Sync)
    ...
    def plot_curve(self):
        ...
        sss = Aggr + "," + Rgl + "," + Sync + "," + str(num_local_iter)+"sync_async"
        ...
        plt.savefig('D:/OneDrive/桌面/实验/code/RSA-Byzantine-master/RSA-code/result2/acc/' + sss + 'alpha2,acc.png')
